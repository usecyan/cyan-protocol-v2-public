...
/// @title Cyan Demo Wallet
/// @author Bulgantamir Gankhuyag - <bulgaa@usecyan.com>
/// @author Naranbayar Uuganbayar - <naba@usecyan.com>
contract CyanDemoWallet is AccessControlUpgradeable {
    struct Call {
        address to;
        uint256 value;
        bytes data;
    ...
    bytes32 public constant CYAN_BLACKLIST_ROLE = keccak256("CYAN_BLACKLIST_ROLE");
    bytes32 public constant CYAN_ROLE = keccak256("CYAN_ROLE");

    function initialize(address _cyanSuperAdmin) external initializer {
    ...
    function isValidSignature(bytes32 data, bytes calldata signature) external view returns (bytes4 magicValue) {
        ...
        require(!hasRole(CYAN_BLACKLIST_ROLE, signer), "Forbidden");
