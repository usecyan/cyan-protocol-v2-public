...
/// @dev This is a mock contract, so we are mocking some not necessary data.
contract CryptoPunksMarket {
    ...
    function setPunksRemainingToAssign(uint256 _punksRemainingToAssign) public {
        punksRemainingToAssign = _punksRemainingToAssign;
    }

    function setAllPunksAssigned(bool _allPunksAssigned) public {
        allPunksAssigned = _allPunksAssigned;
    }
